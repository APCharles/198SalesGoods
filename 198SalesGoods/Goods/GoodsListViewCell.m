...
+ (instancetype) cellWithTableView:(UITableView *)tableview{
    ...
    static NSString *ID = @"GoodsListViewCell";
    GoodsListViewCell *cell = [tableview dequeueReusableCellWithIdentifier:ID];
    if (!cell) {
        
        cell = [[GoodsListViewCell alloc] initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:ID];
...
- (void)setData:(NSDictionary *)data{
    ...
    _titleLale.y = CGRectGetMaxY(_iconView.frame);
